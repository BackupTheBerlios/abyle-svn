...
class abyle_config_write:
		...
		self.buildednode = ""
				...
				self.xmlfile = self.fwconfigpath+self.xmlconfig
                                ...
                                self.abyle_config = xml.dom.minidom.parse(self.fwconfigpath+self.pinterface+'/'+self.xmlconfig)
				self.xmlfile = self.fwconfigpath+self.pinterface+'/'+self.xmlconfig
                except IOError, msg:
                        abyle_output(self.interface+"_config_xmlwriter", "", "", str(msg))
