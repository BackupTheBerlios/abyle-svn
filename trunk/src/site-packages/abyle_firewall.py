...
class abyle_firewall:
	...
	def buildUp(self,protectedif,fwconfigpath):
		...
		self.fwconfigpath = fwconfigpath
		abyle_output("abyle_firewall", "", "", "Building a wall of fire in front of "+self.protectedif)
		if os.path.exists(self.fwconfigpath+'/'+self.protectedif):
			...
			abyle_output("abyle_firewall", "", "", "ERROR: No directory found for interface "+self.protectedif+" in "+self.fwconfigpath)
